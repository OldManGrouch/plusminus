...
namespace hwid {
	std::vector<std::string> list = { 
		...
		c_xor("{91d13540-29f7-11eb-aba3-806e6f6e6963}") , // Jack || R32_
		c_xor("{245cc9a3-631c-11eb-b1ec-806e6f6e6963}") , // Cherry trixy's friend || Harve
		...
		c_xor("{f74c2efa-ecdb-41ec-a069-929d7e14fb9e}") , // blood
		...
		c_xor("{5491405c-53f7-11eb-b9e2-806e6f6e6963}") , // Alfie || sp
